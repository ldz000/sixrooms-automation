...
public class ShiLiuLoginAndPay {
    ...
    public void setup() throws Exception {
        ...
        capabilities.setCapability("appPackage", "cn.v6.sixrooms");
    ...
    public void testShiLiuPay() {
        try {
            ...
            waitForElement(By.id("com.android.permissioncontroller:id/permission_allow_button"));
            driver.findElementById("com.android.permissioncontroller:id/permission_allow_button").click();
            if (waitForElement(By.id("cn.v6.sixrooms:id/account_login_button"))) {
                //点击用户名登录
...
//                driver.findElementByXPath("(//android.widget.ImageView[@content-desc=\"石榴直播\"])[5]").click();
                ...
                waitForElement(By.id("cn.v6.sixrooms:id/account_login_button"));
                driver.findElementById("cn.v6.sixrooms:id/account_login_button").click();
                waitForElement(By.id("cn.v6.sixrooms:id/but_login"));
                driver.findElementById("cn.v6.sixrooms:id/et_username").sendKeys("谜雾迷雾麋了鹿");
                driver.findElementById("cn.v6.sixrooms:id/et_password").sendKeys("1234qwer");
            ...
            String value_init = driver.findElementById("cn.v6.sixrooms:id/tv_six_coin_num").getText();
...
//            driver.findElementByXPath("//android.view.View[@text='确认支付']").click();
            ...
            Thread.sleep(13000);
            targetClick(57, 169);
            String value_change = driver.findElementById("cn.v6.sixrooms:id/tv_six_coin_num").getText();
            int value2 = Integer.parseInt(value_change.replaceAll(",", ""));
            Assert.assertEquals(value1, value2);
        } catch (Exception e) {
            e.printStackTrace();
            Assert.fail();
            log.info("石榴直播充值失败：" + e.getMessage());
        }
    }
