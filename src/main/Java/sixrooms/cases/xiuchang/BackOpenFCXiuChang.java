...
public class BackOpenFCXiuChang {
    ...
    public void testBackOpenFC() {
        ...
        waitForElement(By.id("cn.v6.xiuchang:id/tv_host_name"));
        for (int i = 1; i <= 5; i++) {
        ...
        waitForElement(By.id("cn.v6.xiuchang:id/tv_name"));
        driver.findElementByXPath("//*[@text='粉丝团']").click();
        waitForElement(By.id("cn.v6.xiuchang:id/tv_fans_open"));
        driver.findElementById("cn.v6.xiuchang:id/tv_fans_open").click();
        ...
        waitForElement(By.id("cn.v6.xiuchang:id/tv_host_name"));
        String name = driver.findElementById("cn.v6.xiuchang:id/tv_host_name").getText();
